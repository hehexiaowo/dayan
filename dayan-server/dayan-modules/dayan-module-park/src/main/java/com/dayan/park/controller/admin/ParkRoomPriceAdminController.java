...
public class ParkRoomPriceAdminController {
    ...
    @SaCheckPermission("park:room-price:list")
    @GetMapping("/page")
    ...
    @SaCheckPermission("park:room-price:query")
    @GetMapping("/{id}")
    ...
    @SaCheckPermission("park:room-price:create")
    @PostMapping
    ...
    @SaCheckPermission("park:room-price:update")
    @PutMapping("/{id}")
    ...
    @SaCheckPermission("park:room-price:delete")
    @DeleteMapping("/{id}")
