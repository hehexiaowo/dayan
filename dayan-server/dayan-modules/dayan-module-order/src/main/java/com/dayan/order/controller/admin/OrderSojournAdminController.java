...
public class OrderSojournAdminController {
    ...
    @Operation(summary = "创建旅游短居订单（生成订单号 + 校验金额 + 置待支付）")
    @OperationLog(module = "旅游短居订单", action = "新增")
     ...
     * goodsCode/skuCode 为空时跳过（旅游短居订单可无商品目录关联）。
     */
    ...
    @OperationLog(module = "旅游短居订单", action = "支付")
    ...
    @OperationLog(module = "旅游短居订单", action = "完成")
    ...
    @OperationLog(module = "旅游短居订单", action = "申请退款")
    ...
    @OperationLog(module = "旅游短居订单", action = "取消")
