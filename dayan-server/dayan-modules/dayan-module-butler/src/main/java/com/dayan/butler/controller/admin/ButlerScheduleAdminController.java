...
public class ButlerScheduleAdminController {
    ...
    @SaCheckPermission("butler:schedule:list")
    @GetMapping("/page")
    ...
    @SaCheckPermission("butler:schedule:query")
    @GetMapping("/{id}")
    ...
    @SaCheckPermission("butler:schedule:create")
    @PostMapping
    ...
    @SaCheckPermission("butler:schedule:update")
    @PutMapping("/{id}")
    ...
    @SaCheckPermission("butler:schedule:delete")
    @DeleteMapping("/{id}")
