 ...
 * 线索域相关类型（访客线索池）。
 *
 * 字段对齐后端 com.dayan.lead.vo.LeadInfoVO / LeadTraceVO。
 * - 雪花 id 后端序列化为字符串，前端用 string 承接
 * - Integer → number，LocalDateTime → string
 */
...
/**
 * 线索互动时间线项（后端 LeadTraceVO，内容/工具/海报三类记录合并视图）。
 */
