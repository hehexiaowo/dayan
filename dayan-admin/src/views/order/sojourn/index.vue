...
<template>
  <div class="page-container">
    ...
    <el-card shadow="never">
      <template #header>
        <div class="card-header">
          <span class="card-title">旅游短居列表</span>
        </div>
      </template>
      ...
      <el-table v-loading="loading" :data="tableData" border stripe row-key="orderCode">
        ...
        <el-table-column label="订单类型" width="110" align="center">旅游短居</el-table-column>
    ...
    <!-- 详情弹窗 -->
    <el-dialog v-model="detailVisible" title="旅游短居详情" width="820px" :close-on-click-modal="false">
      <el-descriptions :column="2" border>
        <el-descriptions-item label="订单编号">{{ detail.orderCode }}</el-descriptions-item>
        <el-descriptions-item label="订单类型">旅游短居</el-descriptions-item>
