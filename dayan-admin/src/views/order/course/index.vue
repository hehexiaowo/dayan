...
<template>
  <div class="page-container">
    ...
    <el-card shadow="never">
      <template #header>
        <div class="card-header">
          <span class="card-title">培训课程列表</span>
        </div>
      </template>
      ...
      <el-table v-loading="loading" :data="tableData" border stripe row-key="orderCode">
        ...
        <el-table-column label="订单类型" width="110" align="center">培训课程</el-table-column>
    ...
    <!-- 详情弹窗 -->
    <el-dialog v-model="detailVisible" title="培训课程详情" width="780px" :close-on-click-modal="false">
      <el-descriptions :column="2" border>
        <el-descriptions-item label="订单编号">{{ detail.orderCode }}</el-descriptions-item>
        <el-descriptions-item label="订单类型">培训课程</el-descriptions-item>
