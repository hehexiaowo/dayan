...
async function openEdit(row: ChannelInfo) {
  ...
  try {
    ...
    Object.assign(form, {
      ...
      channelType: detail.channelType ?? ChannelType.GENERAL,
      ...
      status: detail.status ?? ChannelStatus.ENABLED,
    ...
    Object.assign(form, {
      ...
      channelType: row.channelType ?? ChannelType.GENERAL,
    ...
    <el-card shadow="never" class="search-card">
      <el-form :inline="true" :model="query" @submit.prevent>
        <el-form-item label="渠道全称">
          <el-input v-model="query.fullName" placeholder="渠道全称关键字" clearable @keyup.enter="handleSearch" />
        </el-form-item>
