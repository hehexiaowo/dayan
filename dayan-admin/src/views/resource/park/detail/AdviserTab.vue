        ...
        <el-row :gutter="16">
          ...
          <el-col :span="24">
            <el-form-item label="头像">
              <FileUploader v-model="form.adviserImage" type="image" module="park" register-asset asset-ref-type1="park" :asset-ref-code="props.parkCode" asset-ref-type2="adviser" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
