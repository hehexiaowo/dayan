        ...
        <el-row :gutter="16">
          ...
          <el-col :span="24">
            <el-form-item label="封面图">
              <FileUploader v-model="form.coverImage" type="image" module="park" register-asset :asset-park-code="props.parkCode" asset-source-type="service_type" :asset-source-ref="form.serviceTypeCode" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
