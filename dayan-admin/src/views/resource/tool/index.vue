...
/** aichat 头像颜色选项 */
const AICHAT_ICON_COLOR_OPTIONS = [
  { label: '蓝色', value: 'blue' },
...
function openEdit(row: ToolInfo) {
  ...
  Object.assign(form, {
    ...
    status: row.status ?? 1,
    remark: row.remark ?? '',
    ...parsePersonaConfig(row.configJson)
  })
  dialogVisible.value = true
}
...
async function handleSubmit() {
  ...
  const payload: Partial<ToolInfo> = {
    ...
    configJson:
      form.toolType === 'aichat' ? buildPersonaConfigJson() : form.configJson || undefined,
    status: form.status,
          ...
          <el-col :span="12">
            <el-form-item label="工具名称" prop="toolName">
              <el-input
                ...
                :placeholder="form.toolType === 'aichat' ? '即人物名称，如：养老规划师' : '如：AI 创作（公众号）'"
                maxlength="100"
              />
            </el-form-item>
          </el-col>
          ...
          <el-col v-if="form.toolType === 'aichat'" :span="12">
            <el-form-item label="头像颜色">
              <el-select v-model="form.iconColor" style="width: 100%">
                <el-option v-for="o in AICHAT_ICON_COLOR_OPTIONS" :key="o.value" :label="o.label" :value="o.value" />
              </el-select>
            </el-form-item>
          </el-col>
          <el-col v-if="form.toolType === 'aichat'" :span="24">
