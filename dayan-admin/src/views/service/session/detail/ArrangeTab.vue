...
<template>
  <div class="arrange-tab">
    <!-- 搜索栏 -->
    <div class="toolbar">
      <el-select v-model="query.arrangeType" placeholder="安排类型" clearable style="width: 120px">
        <el-option v-for="o in ARRANGE_TYPE_OPTIONS" :key="o.value" :label="o.label" :value="o.value" />
      </el-select>
      <el-select v-model="query.isConfirmed" placeholder="确认状态" clearable style="width: 120px">
        <el-option v-for="o in FOLLOWUP_YES_NO_OPTIONS" :key="o.value" :label="o.label" :value="o.value" />
      </el-select>
      <el-select v-model="query.status" placeholder="安排状态" clearable style="width: 120px">
        <el-option v-for="o in ARRANGE_STATUS_OPTIONS" :key="o.value" :label="o.label" :value="o.value" />
      </el-select>
      <div class="toolbar-actions">
        <el-button type="primary" :icon="'Search'" @click="handleSearch">查询</el-button>
        <el-button type="primary" :icon="'Plus'" @click="openCreate">新增安排</el-button>
      </div>
    </div>
