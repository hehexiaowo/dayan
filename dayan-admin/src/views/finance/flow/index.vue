...
const BIZ_TYPE_OPTIONS = [
  { label: '养老权益 equity_order', value: 'equity_order' },
  { label: '场景营销 scene_order', value: 'scene_order' },
  { label: '培训课程 course_order', value: 'course_order' },
  { label: '旅游短居 travel_order', value: 'travel_order' },
