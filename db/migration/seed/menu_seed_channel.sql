...
INSERT INTO `system_menu` (`menu_code`, `menu_name`, `parent_code`, `menu_type`, `path`, `component`, `permission_code`,
 ...
 `created_at`, `updated_at`, `creator`, `updater`, `deleted`, `deleted_at`)
VALUES
('channel_open', '开放平台', NULL, 1, '/open', NULL, 'channel:open',
...
('channel_open_doc', '接口文档', 'channel_open', 2, '/open/doc', 'open/doc/index', 'channel:openDoc:view',
 'Document', 82, 1, 0, 0, 'channel', 1, NOW(), NOW(), 'system', 'system', 0, NULL),
('channel_open_guide', '接入指南', 'channel_open', 2, '/open/guide', 'open/guide/index', 'channel:openGuide:view',
