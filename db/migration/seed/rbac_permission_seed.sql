...
VALUES
  ...
  -- park:service-type（服务类型）
  ('park:service-type:list',   '服务类型列表', 'park:service-type', 3, '/admin-api/park/service-type', 'GET',     170, 1, '机构服务类型', NOW(), NOW(), 'system', 'system', 0),
  ('park:service-type:query',  '服务类型详情', 'park:service-type', 3, '/admin-api/park/service-type/*', 'GET',    171, 1, '机构服务类型', NOW(), NOW(), 'system', 'system', 0),
  ('park:service-type:create', '新增服务类型', 'park:service-type', 3, '/admin-api/park/service-type', 'POST',    172, 1, '机构服务类型', NOW(), NOW(), 'system', 'system', 0),
  ('park:service-type:update', '修改服务类型', 'park:service-type', 3, '/admin-api/park/service-type/*', 'PUT',    173, 1, '机构服务类型', NOW(), NOW(), 'system', 'system', 0),
  ('park:service-type:delete', '删除服务类型', 'park:service-type', 3, '/admin-api/park/service-type/*', 'DELETE', 174, 1, '机构服务类型', NOW(), NOW(), 'system', 'system', 0),
  -- park:facility-type（设施类型）
  ('park:facility-type:list',   '设施类型列表', 'park:facility-type', 3, '/admin-api/park/facility-type', 'GET',     180, 1, '机构设施类型', NOW(), NOW(), 'system', 'system', 0),
  ('park:facility-type:query',  '设施类型详情', 'park:facility-type', 3, '/admin-api/park/facility-type/*', 'GET',    181, 1, '机构设施类型', NOW(), NOW(), 'system', 'system', 0),
  ('park:facility-type:create', '新增设施类型', 'park:facility-type', 3, '/admin-api/park/facility-type', 'POST',    182, 1, '机构设施类型', NOW(), NOW(), 'system', 'system', 0),
  ('park:facility-type:update', '修改设施类型', 'park:facility-type', 3, '/admin-api/park/facility-type/*', 'PUT',    183, 1, '机构设施类型', NOW(), NOW(), 'system', 'system', 0),
  ('park:facility-type:delete', '删除设施类型', 'park:facility-type', 3, '/admin-api/park/facility-type/*', 'DELETE', 184, 1, '机构设施类型', NOW(), NOW(), 'system', 'system', 0),
  -- park:adviser（顾问）
...
VALUES
  ...
  ('ROLE_OPERATOR', 'park:service-type:list',   NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:service-type:query',  NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:service-type:create', NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:service-type:update', NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:service-type:delete', NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:facility-type:list',   NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:facility-type:query',  NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:facility-type:create', NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:facility-type:update', NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:facility-type:delete', NOW(), NOW(), 'system', 'system', 0),
