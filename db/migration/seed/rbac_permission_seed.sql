...
VALUES
  ...
  -- park:media-image（机构图片）
  ('park:media-image:list',   '机构图片列表', 'park:media-image', 3, '/admin-api/park/media-image', 'GET',     210, 1, '机构图片', NOW(), NOW(), 'system', 'system', 0),
  ('park:media-image:query',  '机构图片详情', 'park:media-image', 3, '/admin-api/park/media-image/*', 'GET',    211, 1, '机构图片', NOW(), NOW(), 'system', 'system', 0),
  ('park:media-image:create', '新增机构图片', 'park:media-image', 3, '/admin-api/park/media-image', 'POST',    212, 1, '机构图片', NOW(), NOW(), 'system', 'system', 0),
  ('park:media-image:update', '修改机构图片', 'park:media-image', 3, '/admin-api/park/media-image/*', 'PUT',    213, 1, '机构图片', NOW(), NOW(), 'system', 'system', 0),
  ('park:media-image:delete', '删除机构图片', 'park:media-image', 3, '/admin-api/park/media-image/*', 'DELETE', 214, 1, '机构图片', NOW(), NOW(), 'system', 'system', 0),
  -- park:media-video（机构视频）
  ('park:media-video:list',   '机构视频列表', 'park:media-video', 3, '/admin-api/park/media-video', 'GET',     220, 1, '机构视频', NOW(), NOW(), 'system', 'system', 0),
  ('park:media-video:query',  '机构视频详情', 'park:media-video', 3, '/admin-api/park/media-video/*', 'GET',    221, 1, '机构视频', NOW(), NOW(), 'system', 'system', 0),
  ('park:media-video:create', '新增机构视频', 'park:media-video', 3, '/admin-api/park/media-video', 'POST',    222, 1, '机构视频', NOW(), NOW(), 'system', 'system', 0),
  ('park:media-video:update', '修改机构视频', 'park:media-video', 3, '/admin-api/park/media-video/*', 'PUT',    223, 1, '机构视频', NOW(), NOW(), 'system', 'system', 0),
  ('park:media-video:delete', '删除机构视频', 'park:media-video', 3, '/admin-api/park/media-video/*', 'DELETE', 224, 1, '机构视频', NOW(), NOW(), 'system', 'system', 0),
  -- park:media-vr（机构 VR）
  ('park:media-vr:list',   '机构VR列表', 'park:media-vr', 3, '/admin-api/park/media-vr', 'GET',     230, 1, '机构VR', NOW(), NOW(), 'system', 'system', 0),
  ('park:media-vr:query',  '机构VR详情', 'park:media-vr', 3, '/admin-api/park/media-vr/*', 'GET',    231, 1, '机构VR', NOW(), NOW(), 'system', 'system', 0),
  ('park:media-vr:create', '新增机构VR', 'park:media-vr', 3, '/admin-api/park/media-vr', 'POST',    232, 1, '机构VR', NOW(), NOW(), 'system', 'system', 0),
  ('park:media-vr:update', '修改机构VR', 'park:media-vr', 3, '/admin-api/park/media-vr/*', 'PUT',    233, 1, '机构VR', NOW(), NOW(), 'system', 'system', 0),
  ('park:media-vr:delete', '删除机构VR', 'park:media-vr', 3, '/admin-api/park/media-vr/*', 'DELETE', 234, 1, '机构VR', NOW(), NOW(), 'system', 'system', 0),
  -- park:media-file（机构文件）
  ('park:media-file:list',   '机构文件列表', 'park:media-file', 3, '/admin-api/park/media-file', 'GET',     240, 1, '机构文件', NOW(), NOW(), 'system', 'system', 0),
...
VALUES
  ...
  ('ROLE_OPERATOR', 'park:media-image:list',   NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:media-image:query',  NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:media-image:create', NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:media-image:update', NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:media-image:delete', NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:media-video:list',   NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:media-video:query',  NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:media-video:create', NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:media-video:update', NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:media-video:delete', NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:media-vr:list',   NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:media-vr:query',  NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:media-vr:create', NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:media-vr:update', NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:media-vr:delete', NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:media-file:list',   NOW(), NOW(), 'system', 'system', 0),
  ('ROLE_OPERATOR', 'park:media-file:query',  NOW(), NOW(), 'system', 'system', 0),
