...
VALUES
  ('admin_dashboard', '工作台', NULL, 2, '/dashboard', 'dashboard/index', NULL, 'Dashboard', 0, 1, 'admin', 1, 'Admin 工作台', NOW(), NOW(), 'system', 'system', 0),
  ...
  ('admin_system_state_machine', '状态机配置', 'admin_system', 2, '/system/state-machine', 'system/stateMachine/index', 'system:sm:list', 'Connection', 5, 1, 'admin', 1, '状态机规则配置', NOW(), NOW(), 'system', 'system', 0),
  ...
  ('admin_resource_supplier', '供应商管理', 'admin_resource', 2, '/resource/supplier', 'resource/supplier/index', 'supplier:info:list', 'Connection', 2, 1, 'admin', 1, '供应商管理', NOW(), NOW(), 'system', 'system', 0),
  ('admin_resource_distributor', '分销商管理', 'admin_resource', 2, '/resource/distributor', 'resource/distributor/index', 'distributor:info:list', 'Share', 3, 1, 'admin', 1, '分销商管理', NOW(), NOW(), 'system', 'system', 0),
  ...
  ('admin_channel_agent', '代理人管理', 'admin_channel', 2, '/channel/agent', 'channel/agent/index', 'agent:info:list', 'Avatar', 2, 1, 'admin', 1, '代理人管理', NOW(), NOW(), 'system', 'system', 0),
  ...
  ('admin_finance_bill', '结算单', 'admin_finance', 2, '/finance/bill', 'finance/bill/index', 'finance:bill:list', 'Tickets', 2, 1, 'admin', 1, '结算单管理', NOW(), NOW(), 'system', 'system', 0),
