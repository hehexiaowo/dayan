...
CREATE TABLE `content_info` (
  ...
  `content_status` TINYINT(2) NOT NULL DEFAULT 0 COMMENT '内容状态（0=草稿, 1=待审核, 2=审核通过, 3=审核驳回, 4=已下线）',
  `audit_status` TINYINT(2) NOT NULL DEFAULT 0 COMMENT '审核状态（0=未审核, 2=通过, 3=驳回）',
...
CREATE TABLE `content_record_share` (
  ...
  `share_channel` TINYINT(2) NOT NULL COMMENT '分享渠道（1=微信, 2=朋友圈, 3=QQ, 4=微博, 5=复制链接, 99=其它）',
