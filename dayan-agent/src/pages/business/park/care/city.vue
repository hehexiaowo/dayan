...
function navigateToDistrict(districtCode: string) {
  uni.navigateTo({
    url: `/pages/business/park/care/district?category=care&provinceCode=${provinceCode.value}&cityCode=${cityCode.value}&districtCode=${districtCode}`,
  });
}
